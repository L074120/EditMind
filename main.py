...
app = FastAPI(title="EditMind API", version="3.0.0", lifespan=lifespan)
...
async def cadastro(dados: AuthRequest):
    ...
    try:
        ...
        if res.session:
            return {"sucesso": True, "token": res.session.access_token,
...
# ══════════════════════════════════════════════════════════════
# ENDPOINT — PROCESSAR VÍDEO (upload direto)
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# ENDPOINT — PROCESSAR YOUTUBE (download + pipeline completo)
# ══════════════════════════════════════════════════════════════
